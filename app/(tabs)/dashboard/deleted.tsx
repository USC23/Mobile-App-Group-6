// // app/(tabs)/dashboard/deleted.tsx
...
//   const confirmPermanentDelete = (id: string, reminderId?: string | null) => {
...
//           // Actually remove by marking deleted again (store approach): here we reuse deleteTask but store keeps "deleted".
//           // If you want to remove completely from store, implement a removeTask function.
//           deleteTask(id);
//         },
//       },
//     ]);
...
//             </View>
//             <View>
//               <TouchableOpacity onPress={() => updateTaskStatus(item.id, 'pending')}><Text style={styles.restore}>Restore</Text></TouchableOpacity>
//               <TouchableOpacity onPress={() => confirmPermanentDelete(item.id, item.reminderId)}><Text style={styles.delete}>Delete</Text></TouchableOpacity>
//             </View>
//           </View>
//         )}
//         ListEmptyComponent={<Text style={styles.empty}>No deleted tasks</Text>}
//       />
//     </View>
//   );
// }
...
//   due: { marginTop: 6, color: '#7f8c8d' },
//   restore: { color: '#2980b9', fontWeight: '700', marginBottom: 8 },
